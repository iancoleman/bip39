...
var phrasesCNs = ('chinese_simplified',
    {
      'Generate':'Generate',
      'Mnemonic':'Mnemonic',
      'Derived Addresses':'Derived Addresses',
      'Derivation Path':'Derivation Path',
      'Mnemonic Code Converter':'助记码转换器',
      'You can enter an existing BIP39 mnemonic, or generate a new random one. Typing your own twelve words will probably not work how you expect, since the words require a particular structure (the last word is a checksum).': '您可以输入现有的BIP39助记符，或生成一个新的随机的。打字自己的十二个字可能不会如你所料，因为这些单词需要一个特定的结构（最后一个字是一个校验和）。',
