...
var phrasesIT = ('italian',
    {
      'Generate':'Generate',
      'Mnemonic':'Mnemonic',
      'Derived Addresses':'Derived Addresses',
      'Derivation Path':'Derivation Path',
      'Mnemonic Code Converter':'Convertitore di codici mnemonici',
      'You can enter an existing BIP39 mnemonic, or generate a new random one. Typing your own twelve words will probably not work how you expect, since the words require a particular structure (the last word is a checksum).': 'È possibile immettere un mnemonico esistente BIP39, o generare un nuovo caso. Digitare le tue dodici parole probabilmente non funzionerà come ti aspetti, poiché le parole richiedono una particolare struttura (l\'ultima parola è un checksum).',
