...
var phrasesCNt = ('chinese_traditional',
    {
      'Generate':'Generate',
      'Mnemonic':'Mnemonic',
      'Derived Addresses':'Derived Addresses',
      'Derivation Path':'Derivation Path',
      'Mnemonic Code Converter':'助記碼轉換器',
      'You can enter an existing BIP39 mnemonic, or generate a new random one. Typing your own twelve words will probably not work how you expect, since the words require a particular structure (the last word is a checksum).': '您可以輸入現有的BIP39助記符，或生成一個新的隨機的。打字自己的十二個字可能不會如你所料，因為這些單詞需要一個特定的結構（最後一個字是一個校驗和）。',
