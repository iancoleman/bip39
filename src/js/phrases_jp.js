...
var phrasesJP = ('japanese',
    {
      'Generate':'Generate',
      'Mnemonic':'Mnemonic',
      'Derived Addresses':'Derived Addresses',
      'Derivation Path':'Derivation Path',
      'Mnemonic Code Converter':'ニーモニックコードコンバータ',
      'You can enter an existing BIP39 mnemonic, or generate a new random one. Typing your own twelve words will probably not work how you expect, since the words require a particular structure (the last word is a checksum).': '既存のBIP39ニーモニックを入力するか、新しいランダムなものを生成することができます。独自の12単語を入力すると、単語が特定の構造（最後の単語はチェックサム）を必要とするため、おそらく期待どおりに動作しません。',
